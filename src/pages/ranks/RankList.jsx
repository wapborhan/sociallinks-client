...
const RankList = ({ user }) => {
  ...
  return (
    <div className="experience-style-two aos-init aos-animate d-md-flex">
      ...
      <div className="experience-right">
        <div className="experience-footer d-flex gap-4">
          <div className="my-0 text-black d-flex gap-4 justify-content-center">
            <div
              className="rn-btn d-flex gap-3 lg-py-3 py-1 lg-px-4 px-2  rounded justify-content-center align-items-center"
              style={{ color: "#f9004d" }}
            >
              <FaEye />
          ...
          <Link className="rn-btn p-3 text-center" to={`/profile/${username}`}>
